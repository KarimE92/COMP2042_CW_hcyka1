...
public class GameFrame extends JFrame implements WindowFocusListener {
    ...
    private final int GameHeight = 450;
    ...
    public GameFrame(){
        ...
        homeMenu = new HomeMenu(this,new Dimension(GameWidth,GameHeight));

        InfoMenu = new InfoMenu(this, new Dimension(GameWidth, GameHeight));
